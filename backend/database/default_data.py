...
def insertDefaultData(engine):
    with Session(engine) as session:
        ...
        meals = []
        workingMeal = Meal(sName = "Rýžové placičky s jablkem a banánem", sType="Snídaně", sDescription = "Uvaříme rýži v osolené vodě. 1/2 (+-) jablka nastrouháme, 1/2 banánu rozmačkáme a smícháme společně s uvařenou rýží a 1 ks vejce. Získáme směs, ze které vytvarujeme na pečící papír placičky a posypeme každou rozdrcenými mandlemi. Pečeme na 200 stupňů 20 minut.")
        ...
        workingMeal = Meal(sName = "Osvěžující borůvkový bowl", sType="Snídaně", sDescription = "Borůvky MRAŽENÉ a kefírové mléko rozmixujeme v mixéru. Dáme do misky a posypeme mandlemi, vlašskými ořechy, semínky a 1/2 banánu.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Smoothie", sType="Snídaně", sDescription = "Vše rozmixujeme. 125g tvaroh = 1/2 60g banán = 1/2")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Banánové smoothie bowl", sType="Snídaně", sDescription = "Mléko (může být živočišné), kakao, chia a banán (1/2) společně umixujeme do hladka. Směs přemístíme do misky, posypeme nastrouhanou čokoládou (1 ks), ořechy a poklademe plátky banánu (1/2). Ihned podáváme.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Jáhly s mandarinkami", sType="Snídaně", sDescription = "Jáhly uvaříme a smícháme je 1 ks hořké čokolády, aby se rozpustila. Ozdobíme mandarinkami z plechovky, semínky a ořechy.")
        ...
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "15", sUnit = "g", ingredient = ingredients["orechy_vlasske"]))
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Kváskový chléb s hummusem, šunkou a sýrem", sType="Snídaně", sDescription = "1 plátek chleba potřeme hummusem, obložíme 2 ks vysokoprocentní šunka a 1 plátek sýru. K tomu ovoce a 1 ks mrkev.")
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "70", sUnit = "g", ingredient = ingredients["kvaskovy_chleb"]))
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Poke bowl", sType="Oběd", sDescription = "Uvaříme rýži (v hotovém stavu +-110g), přendáme do misky a naskládáme na ni čerstvého lososa, avokádo, 1/2 mrkev a kukuřici. Můžeme lehce pokapat sójovou omáčkou.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Tofu s rýžovými nudlemi", sType="Oběd", sDescription = "Rýžové nudle dáme vařit do osolené vody (dle návodu na obalu). Nakrájené tofu na kostičky lehce osmahneme na sucho na pánvičce na mírném ohni. V mističce si připravíme zálivku: med, citron, olej, sůl. Uvařené nudle chvíli orestujeme spolu s tofu, smícháme, přendáme na talíř/do misky, zalejeme zálivkou, smícháme a též smícháme s 1ks nastrouhanou mrkví.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Kváskový chléb s quacamole", sType="Oběd", sDescription = "Avokádo rozmačkáme v misce, přidáme nakrájenou červenou cibuli, 1/2 balení cherry rajčátek. Zakápneme citronovou šťávou, osolíme, zamícháme. Podáváme jako pomazánku na 1 plátek žitný chléb.")
        ...
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "70", sUnit = "g", ingredient = ingredients["kvaskovy_chleb"]))
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Boloňské špagety", sType="Oběd", sDescription = "Mleté maso osmahneš na suché pánvi, až bude hotové přidáš boloňskou omáčku, necháš ohřát, přidáš uvařené špagety (150g +- v hotovém) a na talíři posypeš nastrouhaným sýrem.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Čočka se šmakounem a vejcem", sType="Večeře", sDescription = "Uvaříme čočku, 2 ks vejce. Na lehce potřené pánvi olejem osmahneme 1 ks šmakouna, druhý ks Kubko.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Pečený losos s pečenými batáty", sType="Večeře", sDescription = "Lososa potřeme na pečícím papíru olejem, ochutíme dle svých chutí (sůl, citron, bylinky...) a přihodíme k němu batáty (lze zaměnit s bramborami).")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Zapečená řepa s nivou a vlašskými ořechy", sType="Večeře", sDescription = "pečící papír, posypeme každé kolečko nastrouhanou nivou a na každé kolečko dáme vlašský ořech. Poté dáme do trouby zapéct na 180 stupňů a vyndáme až bude niva do zlatova (cca 30 minut).")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Párky s kváskovým chlebem", sType="Večeře", sDescription = "2 nožičky kvalitních párků s 1 plátkem kváskového chleba s hořčicí (klidně kečup, záleží co máš ráda). K tomu zelenina.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Vepřové ražniči s bramborami", sType="Večeře", sDescription = "Na plech rozprostřeme alobal, vyskládáme na plech (alobal) nakrájené brambory na tenké plátky a vrstvíme maso též nakrájené na plátky, dále přidáme nakrájenou anglickou slaninu (2 ks) a papriku. Nakonec navrstvíme hodně cibule, posypeme grilovacím kořením, zakryjeme alobalem a pečeme na 200°C asi 60 minut.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Kváskový chléb se šunkou a sýrem", sType="Snídaně", sDescription = "1 plátek kváskového chleba potřeme Lučinou, obložíme 2 ks plátky vysokoprocentní šunky, 1 plátkem sýru. K tomu 1ks mrkev a připíjíme 300 ml kefíru.")
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "70", sUnit = "g", ingredient = ingredients["kvaskovy_chleb"]))
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Quinoa salát s halloumi sýrem", sType="Oběd", sDescription = "Quinoa uvedena v syrovém stavu (v hotovém +- 90g). Brokolici můžeme dát na 5 minut vařit. Na ghí (nebo kokosovém oleji) osmahneme nakrájené žampiony, tak stejně osmahneme na plátky nakrájený Halloumi sýr (můžeme na jedné pánvi). Na talíři vše buď smícháme nebo vyskládáme vedle sebe, to už záleží na tobě. Na konec přidáme hrst polníčku či jiné listové zeleniny a posypeme semínky.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Tofu s rýží a kukuřicí", sType="Večeře", sDescription = "Tofu nakrájíme na kostičky a osmahneme na sucho na pánvi. Rýže je uvedena v syrovém stavu, v hotovém potom +- 110g. Talíř doplníme dále o kukuřici, nakrájený pórek (od oka) a semínka. Ochutíme dle svých chutí.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Polotučný tvaroh s kakaem a mandlovým mlékem", sType="Snídaně", sDescription = "Do misky si dáme celý tvaroh, mléko (může být živočišné!), semínka, kakao a smícháme. Ozdobíme musli a ovocem.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Těstovinový salát s tuňákem", sType="Oběd", sDescription = "Těstoviny v hotovém +- 85g. Šťávu z tuňáka slejeme a vše smícháme dohromady - hrst polníčku či jiné listové zeleniny, rajčata, oříšky, semínka a těstoviny. Na konec zakápneme za studena lisovaným olejem. Ochutíme dle svých chutí.")
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "30", sUnit = "g", ingredient = ingredients["testoviny_panzani"]))
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "112", sUnit = "g", ingredient = ingredients["tunak_rio_mare_ve_vlastni_stave"]))
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "50", sUnit = "g", ingredient = ingredients["polnicek"]))
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Gnochi s bazalkovým pestem a parmazánem", sType="Večeře", sDescription = "Uvaříme gnochi, na pánvi mezitím ohřejeme bazalkové pesto a spolu s ním také mírně podusíme cherry rajčátka, uvařené gnochi k němu přidáme, zamícháme a na talíři posypeme parmazánem.")
        ...
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "20", sUnit = "g", ingredient = ingredients["parmezan"]))
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Míchaná vajíčka s baby špenátem a žitným chlebem", sType="Snídaně", sDescription = "Na kokosovém oleji osmahneme 2 míchaná vejce, přidáme na pánev hrst baby špenátu - vše mícháme dohromady. K tomu 1 plátek žitného chleba (může být váš domácí) potřený lučinou + přikusujeme 1/2 jablko.")
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "110", sUnit = "g", ingredient = ingredients["vejce_slepici_m"]))
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "10", sUnit = "g", ingredient = ingredients["kokosovy_olej"]))
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Hovězí steak s fazolkami a americkými bramborami", sType="Oběd", sDescription = "Na pánvi s rozehřátým sádlem na prudko opečeš maso a poté jej dáš spolu s bramborami do trouby. Brambory si včetně slupky jen omyješ, nakrájíš a dáš na sucho vedle masa. Na pánvi po mase poté osmahneš fazolky s česnekem - 1 stroužek.")
        ...
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "5", sUnit = "g", ingredient = ingredients["cesnek"]))
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Omeleta se špenátem a kozím sýrem", sType="Večeře", sDescription = "Vajíčka (2) rozmixujeme spolu s cca hrstí špenátu, přidáme sůl a pepř. Smažíme na kokosovém oleji. Hotovou omeletu naplníme kozím sýrem, pokrájenými ředkvičkami a rukolou.")
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "110", sUnit = "g", ingredient = ingredients["vejce_slepici_m"]))
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "10", sUnit = "g", ingredient = ingredients["kokosovy_olej"]))
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "30", sUnit = "g", ingredient = ingredients["spenat"]))
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Tousty", sType="Snídaně", sDescription = "2 ks toustový chléb (=1 zapečený toust), potřeme lučinou, do toustu: 1 plátek sýr, 2 plátky vysokoprocentní šunky a zapečeme. K tomu 1 červená paprika (+-) a kefírové mléko.")
        ...
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "5", sUnit = "g", ingredient = ingredients["med"]))
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Tuňák, avokádo, rajče, žitný chléb", sType="Večeře", sDescription = "Do misky si dáme 1 plechovku tuňáka (olej/vodu slijeme), nakrájené avokádo, sušená rajčata, ochutíme dle svých chutí (sůl, pepř, ..) a k tomu 1 plátek žitného chleba.")
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "112", sUnit = "g", ingredient = ingredients["tunak_rio_mare_ve_vlastni_stave"]))
        ...
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "50", sUnit = "g", ingredient = ingredients["chleb_zitny"]))
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Jogurt s oříšky, ovocem a semínky", sType="Snídaně", sDescription = "Jogurt smícháme s medem a semínky. Ozdobíme ovocem, oříšky a zdravým müsli.")
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "140", sUnit = "g", ingredient = ingredients["recky_jogurt_milko_5%"]))
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "10", sUnit = "g", ingredient = ingredients["chia_seminka"]))
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "5", sUnit = "g", ingredient = ingredients["med"]))
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "100", sUnit = "g", ingredient = ingredients["boruvky"]))
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Bulgurový salát se zeleninou a cottage sýrem", sType="Oběd", sDescription = "Uvařený bulgur (+-130g v hotovém stavu) smícháme s pokrájenou zeleninou, 1/2 cottage sýrem, semínky a dochutíme dle libosti kořením či bylinkami. Na konec zakápneme za studena lisovaným olejem.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Kváskový chléb s volským okem", sType="Snídaně", sDescription = "Plátek kváskového chleba potřeme lučinou, obložíme plátkem chedaru, na kokosovém oleji osmahneme volské oko, položíme na chleba. K tomu červená paprika.")
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "70", sUnit = "g", ingredient = ingredients["kvaskovy_chleb"]))
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "20", sUnit = "g", ingredient = ingredients["lucina"]))
        ...
        workingMeal.ingredients.append(MealIngredientMap(nQuantity = "150", sUnit = "g", ingredient = ingredients["paprika_cervena"]))
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Caprese s toustovým chlebem", sType="Oběd", sDescription = "2 ks rajčata a mozzarellu nakrájíme na tenké plátky, zakápneme olivovým olejem a posypeme bazalkou. K tomu přikusujeme 1 ks opečený toustový chléb.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Červená řepa s balkánským sýrem a zakysanou smetanou", sType="Večeře", sDescription = "Vařenou červenou řepu nakrájíme na kostičky, smícháme s nakrájeným balkánským sárem a1/4 zakysané smetany. Můžeme přidat česnek. Dochutíme dle svých vlastních chutí a přikusujeme 2 ks knäckebrot.")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Buritto", sType="Oběd", sDescription = "")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Tuňáková pomazánka s žitným chlebem", sType="Snídaně", sDescription = "")
        ...
        meals.append(workingMeal)
        workingMeal = Meal(sName = "Pohanka s kysaným zelím, tempehem a tahini", sType="Oběd", sDescription = "")
        ...
        for group in planGroups.values():
                planList.append(Plan(group = group, sName = "Ranajky"))
                planList.append(Plan(group = group, sName = "Obed"))
                planList.append(Plan(group = group, sName = "Vecera"))
